...
void Reverse0(char* begin, char* end) {
...
char* LeftRotateString(char* pStr, int n) {
    ...
    if (n > 0 && n < length)  {
        ...
        Reverse0(firstBegin, firstEnd);
        Reverse0(secondBegin, secondEnd);
        Reverse0(firstBegin, secondEnd);
    }
